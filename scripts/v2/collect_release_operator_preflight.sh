...
BINARY_PATH="${BINARY_PATH:-$WORKSPACE_ROOT/target/debug/trnm-poco_consensus-app}"
BINARY_BUILD_COMMAND="${BINARY_BUILD_COMMAND:-cargo build -p trnm-native-application --bin trnm-poco_consensus-app}"
