...
- **Touchpoints**:
  - `trillionnium-rust/crates/trnm-state/src/lib.rs` (new gov key: `resolve_authority_next` or `resolve_authority_emergency`)
  - `trillionnium-rust/crates/trnm-pouw/src/lib.rs` (`resolve_authority_account`, `apply_resolve_at_height`)
- **Patch (minimal)**:
...
- **Touchpoints**:
  - `trillionnium-rust/crates/trnm-types/src/lib.rs` (`TaskObject` add `resolve_window_blocks_snapshot: Option<u64>` or equivalent)
  - `trillionnium-rust/crates/trnm-pouw/src/lib.rs` (`apply_reveal_result_at_height`, `apply_challenge_at_height`)
- **Patch (minimal)**:
...
- **Touchpoints**:
  - `trillionnium-rust/crates/trnm-types/src/lib.rs` (`TaskObject` add `worker_stake_locked`)
  - `trillionnium-rust/crates/trnm-pouw/src/lib.rs` (`apply_accept_task`, `required_challenge_bond`)
- **Patch (minimal)**:
...
- **Touchpoints**:
  ...
  - `trillionnium-rust/crates/trnm-pouw/src/lib.rs` (new tests)
  - `trillionnium-rust/crates/trnm-state/src/lib.rs` (new tests)
- **Patch (minimal)**:
