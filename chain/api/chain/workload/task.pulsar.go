...
func init() {
	...
	md_Task = File_chain_workload_task_proto.Messages().ByName("Task")
	fd_Task_id = md_Task.Fields().ByName("id")
	fd_Task_ipfsHash = md_Task.Fields().ByName("ipfsHash")
	fd_Task_bounty = md_Task.Fields().ByName("bounty")
...
func (x *Task) slowProtoReflect() protoreflect.Message {
	mi := &file_chain_workload_task_proto_msgTypes[0]
...
func (x *fastReflection_Task) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "chain.workload.Task.id":
		return x.Id != uint64(0)
	case "chain.workload.Task.ipfsHash":
		return x.IpfsHash != ""
	case "chain.workload.Task.bounty":
		return x.Bounty != uint64(0)
	case "chain.workload.Task.status":
		return x.Status != uint64(0)
	case "chain.workload.Task.worker":
		return x.Worker != ""
	...
	default:
		...
		panic(fmt.Errorf("message chain.workload.Task does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Task) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message chain.workload.Task does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Task) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "chain.workload.Task.id":
		panic(fmt.Errorf("field id of message chain.workload.Task is not mutable"))
	case "chain.workload.Task.ipfsHash":
		panic(fmt.Errorf("field ipfsHash of message chain.workload.Task is not mutable"))
	case "chain.workload.Task.bounty":
		panic(fmt.Errorf("field bounty of message chain.workload.Task is not mutable"))
	case "chain.workload.Task.status":
		panic(fmt.Errorf("field status of message chain.workload.Task is not mutable"))
	case "chain.workload.Task.worker":
		panic(fmt.Errorf("field worker of message chain.workload.Task is not mutable"))
	case "chain.workload.Task.resultHash":
...
func (x *fastReflection_Task) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in chain.workload.Task", d.FullName()))
	}
	panic("unreachable")
}
...
func (*Task) Descriptor() ([]byte, []int) {
	return file_chain_workload_task_proto_rawDescGZIP(), []int{0}
}
...
func (x *Task) GetIpfsHash() string {
	if x != nil {
		return x.IpfsHash
	}
	return ""
...
var file_chain_workload_task_proto_rawDesc = []byte{
	...
	0x12, 0x16, 0x0a, 0x06, 0x62, 0x6f, 0x75, 0x6e, 0x74, 0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04,
	0x52, 0x06, 0x62, 0x6f, 0x75, 0x6e, 0x74, 0x79, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74,
	0x75, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x04, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73,
	0x12, 0x16, 0x0a, 0x06, 0x77, 0x6f, 0x72, 0x6b, 0x65, 0x72, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x06, 0x77, 0x6f, 0x72, 0x6b, 0x65, 0x72, 0x12, 0x1e, 0x0a, 0x0a, 0x72, 0x65, 0x73, 0x75,
...
var (
	file_chain_workload_task_proto_rawDescOnce sync.Once
	file_chain_workload_task_proto_rawDescData = file_chain_workload_task_proto_rawDesc
)

func file_chain_workload_task_proto_rawDescGZIP() []byte {
	file_chain_workload_task_proto_rawDescOnce.Do(func() {
		file_chain_workload_task_proto_rawDescData = protoimpl.X.CompressGZIP(file_chain_workload_task_proto_rawDescData)
	})
	return file_chain_workload_task_proto_rawDescData
}

var file_chain_workload_task_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_chain_workload_task_proto_goTypes = []interface{}{
	(*Task)(nil), // 0: chain.workload.Task
}
var file_chain_workload_task_proto_depIdxs = []int32{
...
func init() { file_chain_workload_task_proto_init() }
func file_chain_workload_task_proto_init() {
	if File_chain_workload_task_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_chain_workload_task_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Task); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_chain_workload_task_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_chain_workload_task_proto_goTypes,
		DependencyIndexes: file_chain_workload_task_proto_depIdxs,
		MessageInfos:      file_chain_workload_task_proto_msgTypes,
	}.Build()
	File_chain_workload_task_proto = out.File
	file_chain_workload_task_proto_rawDesc = nil
	file_chain_workload_task_proto_goTypes = nil
	file_chain_workload_task_proto_depIdxs = nil
}
