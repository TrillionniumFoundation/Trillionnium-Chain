...
cat >"$tmp_file" <<'JSON'
{
  ...
  "provenance": {
    ...
    "produced_at": "2026-03-04T08:50:00Z",
    "provenance_index": "prov:lane-dae:task-20260304-0001",
...
if [[ "$rc" -eq 0 ]]; then
  echo "[FAIL] expected non-zero exit for task_type containing newline" >&2
  exit 1
fi
...
echo "[PASS] D1 schema gate rejects task_type containing newline"
