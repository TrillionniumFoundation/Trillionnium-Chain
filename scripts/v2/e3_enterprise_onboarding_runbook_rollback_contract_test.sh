...
echo "[PASS] E3 runbook keeps rollback/replay contract fields (root-cause-tag/change-ticket-id/operator-id/dry-run/request-id/expect-status/expect-idempotent)"
