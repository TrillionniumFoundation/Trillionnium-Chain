...
assert_contains "${TMP_DIR}/capture.out" "handoff_capture_durable_template_path=trillionnium-rust/docs/release/TRNM_DURABLE_READ_SERVICE_HANDOFF_TEMPLATE_2026-04-04.md"
...
assert_contains "${CAPTURE_DIR}/summary.txt" "durable_template_path=trillionnium-rust/docs/release/TRNM_DURABLE_READ_SERVICE_HANDOFF_TEMPLATE_2026-04-04.md"
...
assert_contains "${CAPTURE_DIR}/summary.txt" "truth_source_go_no_go_panel=trillionnium-rust/docs/release/TRNM_PUBLIC_MAINNET_GO_NO_GO_PANEL_2026-04-04.md"
...
assert_contains "${CAPTURE_DIR}/summary.txt" "replay_command=./trillionnium-rust/scripts/v2/explorer_service_up.sh"
assert_contains "${CAPTURE_DIR}/summary.txt" "status_command=./trillionnium-rust/scripts/v2/explorer_service_status.sh"
assert_contains "${CAPTURE_DIR}/summary.txt" "rollback_command=./trillionnium-rust/scripts/v2/explorer_service_down.sh"
