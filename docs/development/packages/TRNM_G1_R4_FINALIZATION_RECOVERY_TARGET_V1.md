...
chain. Its source is now integrated on the R4C branch, but execution remains
unverified until an authorized clean-checkout runner passes the exact commit.
