...
poco_consensus.role=migration-residue-only
poco_consensus.production_dependency=false
poco_consensus.cleanup_eligible=false
```
...
from legacy PoCO consensus fixtures, local unit tests, queued CI runs, historical audit
