...
| Watermark and migration candidates | `75c969a48`, `5d3458e0e`, `4958bbf17`, `e4581a9c1` | Lower-watermark rejection, typed fresh-genesis boundary, offline target-JMT replay record/head with reopen/divergence checks | Coherent whole-namespace anti-rollback, trusted foreign reader/anchor, quorum handoff or cutover |
