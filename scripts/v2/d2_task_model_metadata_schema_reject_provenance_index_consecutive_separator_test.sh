...
cat >"$tmp_file" <<'JSON'
{
  ...
  "provenance": {
    ...
    "produced_at": "2026-03-03T00:16:00Z",
    "provenance_index": "prov:lane-dae::task-20260303-0816",
...
if [[ "$rc" -eq 0 ]]; then
  echo "[FAIL] expected non-zero exit for consecutive separators in provenance_index" >&2
  exit 1
fi
...
echo "[PASS] D2 schema gate rejects provenance_index with consecutive separators"
