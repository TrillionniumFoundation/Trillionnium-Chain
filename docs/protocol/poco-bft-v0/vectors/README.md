...
- `wire-semantic-v0.json` freezes four complete nested transport frames
  ...
  nested-share accounting, and strict truncation coverage. The
...
- `poco-authenticated-checkpoint-handoff-v0.json` is the dedicated H3b2b3b
  ...
  are not wired to external application adapter startup or a production host, do not cover seal 1/2,
...
bounded shared reconstruction corpus plus canonical external application adapter/SQLite/cache/restart/
