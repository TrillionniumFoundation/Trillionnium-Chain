...
BINARY_PATH="${BINARY_PATH:-$WORKSPACE_ROOT/target/debug/trnm-cometbft-app}"
BINARY_BUILD_COMMAND="${BINARY_BUILD_COMMAND:-cargo build -p trnm-consensus-app --bin trnm-cometbft-app}"
