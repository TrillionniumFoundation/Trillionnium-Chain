...
cat >"$tmp_file" <<'JSON'
{
  ...
  "provenance": {
    ...
    "provenance_index": "prov:lane-dae:task-20260301-2014",
...
echo "[PASS] D3 schema gate allows internal privacy tier with provenance_index"
