...
base=539702c8ea0a067573ee17ce080d7dd45517445b
...
assert m['base_pr']==34
assert m['base_commit']=='539702c8ea0a067573ee17ce080d7dd45517445b'
assert m['base_tree']=='83238ccee38b2de8605e6cd9da29b5e299203c31'
assert m['a13_implementation_commit']==a13['head_commit']=='71f68181f8afa52168bd49d2de7514deb2ddba5a'
assert m['a13_publication_head']=='539702c8ea0a067573ee17ce080d7dd45517445b'
assert m['a13_format_blob']=='e80f9662ad4ab1d3f089698e5f8620c932351150'
...
print('G2C source binding v2: exact formatted A13 publication, final frozen workflow route and false authority guards')
PY
git diff --check
