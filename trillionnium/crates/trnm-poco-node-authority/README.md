...
Authority coordinator boundary for the native PoCO production-shaped node decomposition.
...
cargo test --manifest-path trillionnium/Cargo.toml -p trnm-poco-node-authority --all-targets --locked
```
