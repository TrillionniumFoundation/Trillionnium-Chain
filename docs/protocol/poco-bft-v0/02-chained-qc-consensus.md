...
The validator signs at most one normal vote for that tuple. PoCO-BFT v0 has no PoCO consensus-style prevote/precommit phases; a phase value MUST NOT be invented to permit additional votes in the same view.
