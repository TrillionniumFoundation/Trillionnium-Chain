...
- 若当前 checkout 含有 `docs/reports/TRNM_WEB4_PLATFORM_SCORECARD_2026-03-31.md`，优先引用该 Web4 平台阶段评分卡来描述成熟度位置；它适用的仓库快照是 `main@9ea9e7751`，用于回答“当时大致处于哪个平台阶段”，**不等于** release-ready 证明，也不自动等于当前实时状态
