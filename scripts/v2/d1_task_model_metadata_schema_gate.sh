...
def validate(node, schema_node, prefix=""):
    if schema_node.get("type") == "object":
        ...
        # Validate each present field before evaluating cross-field policy. This
        # gives callers a stable, local error for malformed values instead of
        # masking it behind a later conditional requirement.
