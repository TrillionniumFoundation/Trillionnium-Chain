...
impl fmt::Display for ReleaseBundleErrorV0 {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(match self {
            ...
            Self::ProvenanceBindingMismatch => {
                "source, artifact, SBOM, provenance, or bundle digest mismatch"
            }
        })
    }
}
...
impl<S> Error for ReleaseBundleHostErrorV0<S> where S: Error + 'static {}
