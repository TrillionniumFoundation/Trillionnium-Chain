...
cat >"$tmp_file" <<'JSON'
{
  ...
  "provenance": {
    ...
    "produced_at": "2026-03-02T01:50:00Z",
    "provenance_index": "prov:lane-dae:task-20260302-0003",
...
if [[ "$rc" -eq 0 ]]; then
  echo "[FAIL] expected non-zero exit for leading-space model.version" >&2
  exit 1
fi
...
echo "[PASS] D1 schema gate rejects model.version with leading space"
