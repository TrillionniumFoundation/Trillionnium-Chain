...
#[path = "submit_message_metadata_validation/accept.rs"]
mod accept;
#[path = "submit_message_metadata_validation/metadata.rs"]
mod metadata;
#[path = "submit_message_metadata_validation/payload.rs"]
mod payload;
#[path = "submit_message_metadata_validation/provenance.rs"]
mod provenance;
