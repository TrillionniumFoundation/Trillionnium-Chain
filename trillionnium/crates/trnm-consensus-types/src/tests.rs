...
use crate::{
    canonical::{
        ...
        DOMAIN_HANDOFF_SIGN_INTENT_V1, DOMAIN_HANDOFF_VOTE, DOMAIN_ORDERED_LEAF,
        DOMAIN_ORDERED_NODE, DOMAIN_ORDERED_ROOT, DOMAIN_PARAMETERS, DOMAIN_PROPOSAL,
        DOMAIN_QUORUM_CERTIFICATE, DOMAIN_RECOVERY_CAUGHT_UP_CUT_V1, DOMAIN_RECOVERY_CONTEXT_V1,
        DOMAIN_RECOVERY_READY_SET_V1, DOMAIN_RECOVERY_READY_V1,
        DOMAIN_RECOVERY_START_CERTIFICATE_V1, DOMAIN_RECOVERY_START_V1,
        DOMAIN_RECOVERY_ZERO_DELTA_CUT_V1, DOMAIN_SIGN_INTENT, DOMAIN_TIMEOUT,
...
fn every_frozen_domain_matches_empty_payload_vector() {
    let vectors = [
        ...
        (
            ...
            "2ccf8acbbb78875fd4155c1056d42825d1ed1d1c7e0b92d2172c87c265761ebd",
        ),
        (
        ...
        (
            ...
            "610486f25c379f48982448dad7256991e2c7bb69152af6f2edbff1aa8097631c",
        ),
        (
            DOMAIN_RECOVERY_CAUGHT_UP_CUT_V1,
            "782dbd8d0d61468ae11e235826980aeb9fd8d7fc05480b51cc1153702f985c11",
        ),
        (
            DOMAIN_RECOVERY_ZERO_DELTA_CUT_V1,
            "b29ff3ccb96faba90dc824fb4cc9c1f95dd0b60c1166bfe4c721d9cd919a23d4",
        ),
        (
            DOMAIN_RECOVERY_READY_V1,
            "1f5886536f1f6f61f8376fc927dd8f3766a5ed6268585347e28f9f7b0323d3c0",
        ),
        (
            DOMAIN_RECOVERY_READY_SET_V1,
            "461608e16381e7944dee970ec826da0ec6680f59bfda3a2015987c841653b082",
        ),
        (
            DOMAIN_RECOVERY_START_V1,
            "dc0b046bc001d8f4499bd09e541b0bf24a378f4283a06e349b612c55adbeb077",
        ),
        (
            DOMAIN_RECOVERY_START_CERTIFICATE_V1,
            "98b716248be8e4e7e857c354445ea43b00b7d34e510eedd6a125935554a1b620",
        ),
    ];
