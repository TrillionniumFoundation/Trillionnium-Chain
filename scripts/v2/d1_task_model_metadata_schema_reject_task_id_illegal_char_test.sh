...
cat >"$tmp_file" <<'JSON'
{
  ...
  "provenance": {
    ...
    "produced_at": "2026-03-01T05:45:00Z",
    "provenance_index": "prov:lane-dae:task-20260301-0016",
...
if [[ "$rc" -eq 0 ]]; then
  echo "[FAIL] expected non-zero exit for task_id containing illegal slash character" >&2
  exit 1
fi
...
echo "[PASS] D1 schema gate rejects task_id containing illegal slash character"
