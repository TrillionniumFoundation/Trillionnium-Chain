...
set +e
UMASK=bad QUICK_GATE_SKIP_SHELLCHECK=1 bash "$SCRIPT" "$ROOT/scripts" >"$TMP_DIR/stdout.log" 2>"$TMP_DIR/stderr.log"
rc=$?
set -e
...
echo "[PASS] quick_gate rejects invalid UMASK values"
