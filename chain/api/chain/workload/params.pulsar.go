...
func (x *Params) slowProtoReflect() protoreflect.Message {
	mi := &file_chain_workload_params_proto_msgTypes[0]
...
func (x *fastReflection_Params) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.WorkloadDenom != "" {
		value := protoreflect.ValueOfString(x.WorkloadDenom)
		if !f(fd_Params_workload_denom, value) {
			return
		}
	}
}
...
func (x *fastReflection_Params) Has(fd protoreflect.FieldDescriptor) bool {
	...
	default:
		...
		panic(fmt.Errorf("message chain.workload.Params does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Params) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message chain.workload.Params does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Params) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in chain.workload.Params", d.FullName()))
	}
	panic("unreachable")
}
...
func (x *fastReflection_Params) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.WorkloadDenom) > 0 {
			...
			copy(dAtA[i:], x.WorkloadDenom)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.WorkloadDenom)))
			i--
			dAtA[i] = 0xa
		}
		if input.Buf != nil {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 1:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field WorkloadDenom", wireType)
				}
...
func (*Params) Descriptor() ([]byte, []int) {
	return file_chain_workload_params_proto_rawDescGZIP(), []int{0}
}

func (x *Params) GetWorkloadDenom() string {
	if x != nil {
		return x.WorkloadDenom
	}
	return ""
...
var (
	file_chain_workload_params_proto_rawDescOnce sync.Once
	file_chain_workload_params_proto_rawDescData = file_chain_workload_params_proto_rawDesc
)

func file_chain_workload_params_proto_rawDescGZIP() []byte {
	file_chain_workload_params_proto_rawDescOnce.Do(func() {
		file_chain_workload_params_proto_rawDescData = protoimpl.X.CompressGZIP(file_chain_workload_params_proto_rawDescData)
	})
	return file_chain_workload_params_proto_rawDescData
}

var file_chain_workload_params_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_chain_workload_params_proto_goTypes = []interface{}{
	(*Params)(nil), // 0: chain.workload.Params
}
var file_chain_workload_params_proto_depIdxs = []int32{
...
func init() { file_chain_workload_params_proto_init() }
func file_chain_workload_params_proto_init() {
	if File_chain_workload_params_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_chain_workload_params_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Params); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_chain_workload_params_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_chain_workload_params_proto_goTypes,
		DependencyIndexes: file_chain_workload_params_proto_depIdxs,
		MessageInfos:      file_chain_workload_params_proto_msgTypes,
	}.Build()
	File_chain_workload_params_proto = out.File
	file_chain_workload_params_proto_rawDesc = nil
	file_chain_workload_params_proto_goTypes = nil
	file_chain_workload_params_proto_depIdxs = nil
}
