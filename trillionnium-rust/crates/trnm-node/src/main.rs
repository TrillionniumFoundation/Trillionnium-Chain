...
mod tests {
    ...
    fn shipped_bootstrap_readme_matches_the_documented_day1_topology_and_fail_closed_model() {
        ...
        for expected_phrase in [
            ...
            "prefer the exact repo-root paths `trillionnium-rust/configs/node1.toml`, `trillionnium-rust/configs/node2.toml`, `trillionnium-rust/configs/node3.toml`, and `trillionnium-rust/configs/node4.toml` as the unambiguous slot references",
