...
func (x *fastReflection_GenesisState) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.UnbondingList) != 0 {
		value := protoreflect.ValueOfList(&_GenesisState_5_list{list: &x.UnbondingList})
		if !f(fd_GenesisState_unbondingList, value) {
			return
		}
	}
...
func (x *fastReflection_GenesisState) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "chain.workload.GenesisState.workerList":
		...
		return protoreflect.ValueOfList(value)
	case "chain.workload.GenesisState.unbondingList":
		if x.UnbondingList == nil {
			x.UnbondingList = []*Unbonding{}
		}
...
func (x *fastReflection_GenesisState) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.UnbondingList) > 0 {
			for iNdEx := len(x.UnbondingList) - 1; iNdEx >= 0; iNdEx-- {
				encoded, err := options.Marshal(x.UnbondingList[iNdEx])
				if err != nil {
					return protoiface.MarshalOutput{
						NoUnkeyedLiterals: input.NoUnkeyedLiterals,
						Buf:               input.Buf,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 5:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field UnbondingList", wireType)
				}
				var msglen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.UnbondingList = append(x.UnbondingList, &Unbonding{})
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.UnbondingList[len(x.UnbondingList)-1]); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			case 6:
...
func (x *GenesisState) GetUnbondingList() []*Unbonding {
	if x != nil {
		return x.UnbondingList
	}
	return nil
}
...
var file_chain_workload_genesis_proto_rawDesc = []byte{
	...
	0x52, 0x0a, 0x77, 0x6f, 0x72, 0x6b, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x45, 0x0a, 0x0d,
	0x75, 0x6e, 0x62, 0x6f, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x4c, 0x69, 0x73, 0x74, 0x18, 0x05, 0x20,
