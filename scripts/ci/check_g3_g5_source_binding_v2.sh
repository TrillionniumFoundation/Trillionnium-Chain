...
base=4ce9a7880084c96903cf296e1d0c0f67c44118b9
...
assert m['base_pr']==37
assert m['base_commit']=='4ce9a7880084c96903cf296e1d0c0f67c44118b9'
assert m['base_tree']=='f024e4478bfb793757cf4dce0b8e78a3a6d51713'
...
assert a16['base_commit']=='b56add633cc289b745e5d3df74746e6396aed9ed'
...
print('G3-G5 source binding v2: exact rebound A16 STOP input, frozen workflow route and all real claims disabled')
PY
git diff --check
