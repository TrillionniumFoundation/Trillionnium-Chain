...
mod tests {
    ...
    fn checkpoint_da_light_verifier_summary_marks_genesis_wal_prev_hash_as_none() {
        ...
        assert_eq!(
            summary,
            format!(
                "da_light_surface=checkpoint-wal-v1 light_verifier_surface=checkpoint-wal-v1 checkpoint_commitment={} checkpoint_commitment_kind=canonical-hex-32b checkpoint_commitment_bytes=32 checkpoint_height=1 checkpoint_state_root={} checkpoint_state_root_kind=canonical-hex-32b checkpoint_state_root_bytes=32 checkpoint_wal_entry_hash={} checkpoint_wal_entry_hash_kind=canonical-hex-32b checkpoint_wal_entry_hash_bytes=32 checkpoint_height_matches_wal=true checkpoint_state_root_matches_wal=true checkpoint_wal_entry_hash_matches_wal=true checkpoint_surface_canonical=true wal_height=1 wal_state_root={} wal_state_root_kind=canonical-hex-32b wal_state_root_bytes=32 wal_content_hash={} wal_content_hash_kind=canonical-hex-32b wal_content_hash_bytes=32 wal_content_hash_matches_checkpoint=true wal_committed=true wal_prev_hash=none wal_prev_hash_present=false wal_prev_hash_kind=genesis wal_prev_hash_bytes=0 wal_prev_hash_surface_canonical=true wal_round=0 wal_proposal_hash=proposal-genesis wal_proposal_hash_present=true wal_proposal_hash_kind=opaque-ascii wal_proposal_hash_bytes=16 wal_proposal_hash_surface_canonical=true",
                checkpoint.commitment_hex(),
                checkpoint.state_root_hex,
                checkpoint.wal_entry_hash_hex,
                wal.state_root_hex,
