...
if [ -n "$PREFLIGHT_PATH" ]; then
  ...
  preflight_status_summary="$(require_key "$PREFLIGHT_PATH" git_status_summary)"
...
assert_equal git_status_summary summary "$summary_status_summary" manifest "$manifest_status_summary"
...
if [ -n "$PREFLIGHT_PATH" ]; then
  ...
  assert_equal preflight.git_status_summary preflight "$preflight_status_summary" summary "$summary_status_summary"
