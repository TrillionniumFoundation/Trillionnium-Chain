...
use trnm_node_boundary_v0::{
    AuthorityCommandV0, AuthorityCoordinatorV0, Digest32V0 as NodeDigestV0,
...
fn authority_and_snapshot_stores_reject_concurrent_writers() {
    ...
    let first = AtomicSnapshotFileTargetV0::open_or_initialize(
        &snapshot_dir.0,
        sync_digest(10),
        1,
        1,
    ...
    .unwrap();
    assert!(matches!(
        AtomicSnapshotFileTargetV0::open_or_initialize(
            &snapshot_dir.0,
            sync_digest(10),
            1,
            1,
