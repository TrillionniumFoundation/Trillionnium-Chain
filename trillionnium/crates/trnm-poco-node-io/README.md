...
I/O runtime boundary for the native PoCO production-shaped node decomposition.
...
cargo test --manifest-path trillionnium/Cargo.toml -p trnm-poco-node-io --all-targets --locked
```
