...
operator_ack=alice checked genesis_artifact_sha256=<64-char-sha256>;config_path=configs/node1.toml;validator_name=node1
...
operator_ack=bob checked genesis_artifact_sha256=<64-char-sha256>;config_path=configs/node2.toml;validator_name=node2
...
- if `ceremony_scope=public-mainnet-input`, do not treat a generated packet as signed/public-mainnet handoff evidence until every `validator_entry=` has a named owner/contact and every `operator_ack` / `operator_ack_signature_path` line has been filled with the real acknowledgment artifact for that validator
