...
#[test]
fn x3_prep_manual_degraded_heartbeat_invalid_embedded_metrics_compensates_without_state_drift() {
...
#[test]
fn x3_prep_manual_degraded_heartbeat_target_ahead_embedded_metrics_compensates_without_state_drift() {
