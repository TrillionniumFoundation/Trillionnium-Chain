...
#[test]
fn reserve_only_qos_snapshot_reopened_shared_slot_survives_same_class_duplicate_noise() {
    ...
    // Same-class duplicate probes must remain purely classificatory and leave the
