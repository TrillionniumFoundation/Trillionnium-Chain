...
cargo test -p trnm-types settlement_evidence_path_replaces_empty_route_segments_with_placeholder
...
cargo test -p trnm-types settlement_evidence_path_sanitizes_arabic_letter_mark_controls
cargo test -p trnm-types settlement_evidence_path_sanitizes_word_joiner_controls
cargo test -p trnm-types settlement_evidence_path_sanitizes_windows_reserved_punctuation
...
cargo test -p trnm-types settlement_evidence_path_avoids_windows_reserved_device_names_with_unicode_space_padding
cargo test -p trnm-types settlement_evidence_path_trims_trailing_dot_or_space_for_non_reserved_segments
