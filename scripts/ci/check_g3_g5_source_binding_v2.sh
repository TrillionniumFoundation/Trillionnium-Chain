...
base=316b2d4227764e1a2174f46c57a25272ced96f82
...
assert m['base_pr']==37
assert m['base_commit']=='316b2d4227764e1a2174f46c57a25272ced96f82'
assert m['base_tree']=='76f2bd4075d961c3a32df66d5bfdee9ccd5181b7'
...
assert a16['base_commit']=='0d78161b73a7c709506ec16709d40d434da56918'
assert a16['head_commit']=='6d093ce67fd3c5fff2ee8822b0fe56842578026d'
assert 'A16-SYNCHRONIZED-A12-A15-CANDIDATE-INPUTS' in a16['gaps_closed']
...
print('G3-G5 source binding v2: synchronized A16 STOP input, strict external evaluator and all real claims disabled')
PY
git diff --check
