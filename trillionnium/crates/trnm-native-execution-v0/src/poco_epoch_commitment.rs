...
fn verify_poco_next_epoch_commitment_v0(
    ...
    // parent; it is not checkpoint execution authority. The complete native
    // body/receipt/execution join is performed by the checkpoint owner before
    // the later strict checkpoint/two-seal and handoff composition.
