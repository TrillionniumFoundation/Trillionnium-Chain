...
#[test]
fn reserve_only_qos_snapshot_closes_when_normal_consumes_last_refill_slot_after_duplicate_noise() {
    ...
    // directly; once it does, both ingress classes must observe the same fully
    // closed snapshot immediately.
