...
- `trillionnium-rust/docs/release/TRNM_MAINNET_READINESS_REASSESSMENT_2026-04-05.md`
- `trillionnium-rust/docs/release/TRNM_MAINNET_CLOSURE_EXECUTION_BOARD_2026-04-05.md`
...
- current `trnm-rpc` path handlers and parsing logic in `trillionnium-rust/crates/trnm-rpc/src/main.rs`
