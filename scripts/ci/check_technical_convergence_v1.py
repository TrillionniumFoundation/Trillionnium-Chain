...
HELPER_BLOBS = {
    pathlib.Path("scripts/ci/technical_convergence_contract_v1.py"): "9707292d893f810cbf130ecede702597bf07cdb2",
    pathlib.Path("scripts/ci/technical_convergence_workflows_v1.py"): "92031992aac0a872345a9fce7494801f500fa0a5",
