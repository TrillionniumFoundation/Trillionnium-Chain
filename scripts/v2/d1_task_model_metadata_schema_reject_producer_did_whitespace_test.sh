...
if [[ "$rc" -eq 0 ]]; then
  echo "[FAIL] expected non-zero exit for producer_did whitespace violation" >&2
  exit 1
fi
...
echo "[PASS] D1 schema gate rejects producer_did containing whitespace"
