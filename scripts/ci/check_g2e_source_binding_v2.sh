...
base=839345825396343290a59d329eb38e6b3ecb4576
...
assert m['base_pr']==35
assert m['base_commit']=='839345825396343290a59d329eb38e6b3ecb4576'
assert m['base_tree']=='3b1ab558b23353f190c3cab51d1140d84049e30a'
assert m['a14_implementation_commit']==a14['head_commit']=='0eed454d2895b8b034ada2af6bf96006cb094475'
assert m['a14_base_sync_commit']=='839345825396343290a59d329eb38e6b3ecb4576'
...
print('G2E source binding v2: exact A14 publication, final frozen workflow route and false authority guards')
PY
git diff --check
