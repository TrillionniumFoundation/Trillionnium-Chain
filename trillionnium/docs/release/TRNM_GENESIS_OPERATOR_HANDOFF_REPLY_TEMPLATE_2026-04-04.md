...
建议按这个顺序回：
1. 先填 `ceremony_id / packet_generated_at / packet_distribution_path / validator_set_version / startup_order_note / rollback_owner / dr_summary_path / dr_replay_command / dr_rollback_command`
