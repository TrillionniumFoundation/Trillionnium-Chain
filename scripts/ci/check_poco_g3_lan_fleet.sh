...
readonly -a NO_CARGO_EXPECTED_SUMMARIES=(
  ...
  'native_campaign_structural_tests=passed negatives=31 cryptographic_success_claim=false real_campaign_required=true controlled_ssh_unix_transport=true bounded_io_deadline=true'
)
