...
pub(crate) use adapter_error_ops::{
    ...
    reputation_impact_from_gap_bps_from_best, reputation_impact_from_label,
    reputation_impact_from_rank_ordinal, reputation_impact_from_score_bps,
    reputation_impact_from_score_impact, reputation_gap_bps_from_best,
    ...
    reputation_score_impact, reputation_signal_from_delta,
    reputation_signal_from_gap_bps_from_best, reputation_signal_from_label,
    reputation_signal_from_rank_ordinal, reputation_signal_from_score_bps,
    reputation_signal_from_score_impact, reputation_signal_from_surface,
    reputation_signal_from_tier, reputation_signal_from_weight_bps, reputation_surface,
    reputation_tier, reputation_weight_bps, ReputationImpact, ReputationSurface,
};
