...
assert a14['base_commit']=='cd5264438c0ea1e81bd687355eccac1d49e92b26'
...
print('G2E source binding v2: exact synchronized A14 candidate and false authority guards')
PY
