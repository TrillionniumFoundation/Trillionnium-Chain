...
It does not yet make the existing PoCO consensus runtime authoritative, close every
...
state encode/decode, SQLite startup and schema migration, and native application boundary snapshot
...
## 20. Application-authenticated B2-G reconstruction (implementation and native application boundary/restart evidence landed; remaining evidence in progress)
