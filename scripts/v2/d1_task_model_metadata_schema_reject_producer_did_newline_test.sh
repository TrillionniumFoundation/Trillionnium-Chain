...
cat >"$tmp_file" <<'JSON'
{
  ...
  "provenance": {
    "producer_did": "did:trnm:org\nlane-dae",
    "produced_at": "2026-03-04T07:41:00Z",
    "provenance_index": "prov:lane-dae:task-20260304-1541",
...
if [[ "$rc" -eq 0 ]]; then
  echo "[FAIL] expected non-zero exit for producer_did containing newline" >&2
  exit 1
fi
...
echo "[PASS] D1 schema gate rejects producer_did containing newline"
