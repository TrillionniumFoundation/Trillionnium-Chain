...
impl PlanActionV0 {
    ...
    pub fn canonical_digest(&self) -> Digest32V0 {
        match self {
            ...
            Self::Forbidden(action) => Digest32V0::hash(
                b"trnm.control.action.forbidden.v0",
                &[&[*action as u8]],
            ),
        }
    }
                            ...
                            ParameterClassV0::DeterminismCritical => match determinism {
                                Some(evidence)
                                    if evidence.plan_digest == plan.canonical_plan_digest
                                        ...
                                        && evidence.worker_invariance_digest != Digest32V0([0; 32])
...
impl fmt::Display for ControlPlaneErrorV0 {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(match self {
            ...
            Self::ForbiddenAuthorityAction => "control plane requested a forbidden authority action",
            ...
            Self::MissingDeterminismEvidence => "determinism-critical action lacks root-invariance evidence",
            Self::MissingGovernanceAuthorization => "consensus-critical action lacks governance authorization",
...
impl<S> Error for ControlPlaneHostErrorV0<S>
where
    S: Error + 'static,
{
}
...
mod tests {
    ...
    #[test]
    fn forbidden_authority_is_explicitly rejected() {
