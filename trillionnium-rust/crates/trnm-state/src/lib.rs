...
impl WalMeta {
    ...
    pub fn evidence_summary(&self) -> String {
        ...
        let wal_proposal_hash_surface_policy = "ascii-trimmed-no-ws-control-max128";
...
pub fn checkpoint_da_light_verifier_summary(
    ...
    let wal_prev_hash_matches_height_boundary =
        wal_prev_hash_present == (wal_entry.height > 1);
    let wal_prev_hash_surface_policy = "canonical-hex-32b-or-none";
    ...
    Some(format!(
        "da_light_surface=checkpoint-wal-v1 light_verifier_surface=checkpoint-wal-v1 da_state_commitment={} da_state_commitment_kind={} da_state_commitment_bytes={} da_state_commitment_matches_checkpoint_state_root=true da_checkpoint_commitment={} da_checkpoint_commitment_kind={} da_checkpoint_commitment_bytes={} da_checkpoint_commitment_matches_checkpoint_commitment=true da_wal_content_hash={} da_wal_content_hash_kind={} da_wal_content_hash_bytes={} da_wal_content_hash_matches_checkpoint_wal_entry_hash=true checkpoint_binding_fields=height,state_root,wal_entry_hash checkpoint_tuple_order=height,state_root,wal_entry_hash checkpoint_tuple_encoding=sha256(len-prefixed height-le-u64|state_root|wal_entry_hash) checkpoint_commitment_fields=height,state_root,wal_entry_hash checkpoint_commitment_encoding=sha256(len-prefixed height-le-u64|state_root|wal_entry_hash) checkpoint_commitment_binding_kind=tuple-hash checkpoint_commitment={} checkpoint_commitment_kind={} checkpoint_commitment_bytes={} checkpoint_commitment_matches_recomputed=true checkpoint_height={} checkpoint_height_encoding={} checkpoint_height_bytes=8 checkpoint_state_root={} checkpoint_state_root_kind={} checkpoint_state_root_bytes={} checkpoint_wal_entry_hash={} checkpoint_wal_entry_hash_kind={} checkpoint_wal_entry_hash_bytes={} checkpoint_height_matches_wal=true checkpoint_state_root_matches_wal=true checkpoint_wal_entry_hash_matches_wal=true checkpoint_wal_binding_kind=content-hash-equality checkpoint_surface_canonical=true wal_content_hash_fields=height,round,proposal_hash,committed,state_root,prev_hash wal_tuple_order=height,round,proposal_hash,committed,state_root,prev_hash wal_tuple_encoding=sha256(len-prefixed height-le-u64|round-le-u64|proposal_hash|committed-u8|state_root|prev_hash?) wal_height={} wal_height_encoding={} wal_height_bytes=8 wal_round={} wal_round_encoding={} wal_round_kind={} wal_round_bytes=8 wal_state_root={} wal_state_root_kind={} wal_state_root_bytes={} wal_content_hash={} wal_content_hash_kind={} wal_content_hash_bytes={} wal_content_hash_matches_recomputed=true wal_content_hash_matches_checkpoint=true wal_content_hash_matches_checkpoint_wal_entry_hash=true wal_committed={} wal_committed_encoding={} wal_committed_kind={} wal_committed_bytes=1 wal_height_boundary_kind={} wal_prev_hash={} wal_prev_hash_present={} wal_prev_hash_kind={} wal_prev_hash_matches_height_boundary={} wal_prev_hash_bytes={} wal_prev_hash_surface_policy={} wal_prev_hash_surface_canonical=true wal_linkage_kind=prev-hash-chain wal_proposal_hash={} wal_proposal_hash_present={} wal_proposal_hash_kind={} wal_proposal_hash_bytes={} wal_proposal_hash_surface_policy={} wal_proposal_hash_surface_canonical=true",
...
mod tests {
    ...
    fn checkpoint_da_light_verifier_summary_is_canonical_and_includes_wal_linkage() {
        ...
        assert_eq!(
            summary,
            format!(
                "da_light_surface=checkpoint-wal-v1 light_verifier_surface=checkpoint-wal-v1 da_state_commitment={} da_state_commitment_kind=canonical-hex-32b da_state_commitment_bytes=32 da_state_commitment_matches_checkpoint_state_root=true da_checkpoint_commitment={} da_checkpoint_commitment_kind=canonical-hex-32b da_checkpoint_commitment_bytes=32 da_checkpoint_commitment_matches_checkpoint_commitment=true da_wal_content_hash={} da_wal_content_hash_kind=canonical-hex-32b da_wal_content_hash_bytes=32 da_wal_content_hash_matches_checkpoint_wal_entry_hash=true checkpoint_binding_fields=height,state_root,wal_entry_hash checkpoint_tuple_order=height,state_root,wal_entry_hash checkpoint_tuple_encoding=sha256(len-prefixed height-le-u64|state_root|wal_entry_hash) checkpoint_commitment_fields=height,state_root,wal_entry_hash checkpoint_commitment_encoding=sha256(len-prefixed height-le-u64|state_root|wal_entry_hash) checkpoint_commitment_binding_kind=tuple-hash checkpoint_commitment={} checkpoint_commitment_kind=canonical-hex-32b checkpoint_commitment_bytes=32 checkpoint_commitment_matches_recomputed=true checkpoint_height=7 checkpoint_height_encoding=le-u64 checkpoint_height_bytes=8 checkpoint_state_root={} checkpoint_state_root_kind=canonical-hex-32b checkpoint_state_root_bytes=32 checkpoint_wal_entry_hash={} checkpoint_wal_entry_hash_kind=canonical-hex-32b checkpoint_wal_entry_hash_bytes=32 checkpoint_height_matches_wal=true checkpoint_state_root_matches_wal=true checkpoint_wal_entry_hash_matches_wal=true checkpoint_wal_binding_kind=content-hash-equality checkpoint_surface_canonical=true wal_content_hash_fields=height,round,proposal_hash,committed,state_root,prev_hash wal_tuple_order=height,round,proposal_hash,committed,state_root,prev_hash wal_tuple_encoding=sha256(len-prefixed height-le-u64|round-le-u64|proposal_hash|committed-u8|state_root|prev_hash?) wal_height=7 wal_height_encoding=le-u64 wal_height_bytes=8 wal_round=3 wal_round_encoding=le-u64 wal_round_kind=bft-round-u64 wal_round_bytes=8 wal_state_root={} wal_state_root_kind=canonical-hex-32b wal_state_root_bytes=32 wal_content_hash={} wal_content_hash_kind=canonical-hex-32b wal_content_hash_bytes=32 wal_content_hash_matches_recomputed=true wal_content_hash_matches_checkpoint=true wal_content_hash_matches_checkpoint_wal_entry_hash=true wal_committed=true wal_committed_encoding=u8 wal_committed_kind=commit-flag-u8 wal_committed_bytes=1 wal_height_boundary_kind=non-genesis wal_prev_hash={} wal_prev_hash_present=true wal_prev_hash_kind=linked wal_prev_hash_matches_height_boundary=true wal_prev_hash_bytes=32 wal_prev_hash_surface_policy=canonical-hex-32b-or-none wal_prev_hash_surface_canonical=true wal_linkage_kind=prev-hash-chain wal_proposal_hash=proposal-7 wal_proposal_hash_present=true wal_proposal_hash_kind=opaque-ascii wal_proposal_hash_bytes=10 wal_proposal_hash_surface_policy=ascii-trimmed-no-ws-control-max128 wal_proposal_hash_surface_canonical=true",
                checkpoint.state_root_hex,
                checkpoint.commitment_hex(),
    ...
    fn checkpoint_da_light_verifier_summary_marks_genesis_wal_prev_hash_as_none() {
        ...
        assert_eq!(
            summary,
            format!(
                "da_light_surface=checkpoint-wal-v1 light_verifier_surface=checkpoint-wal-v1 da_state_commitment={} da_state_commitment_kind=canonical-hex-32b da_state_commitment_bytes=32 da_state_commitment_matches_checkpoint_state_root=true da_checkpoint_commitment={} da_checkpoint_commitment_kind=canonical-hex-32b da_checkpoint_commitment_bytes=32 da_checkpoint_commitment_matches_checkpoint_commitment=true da_wal_content_hash={} da_wal_content_hash_kind=canonical-hex-32b da_wal_content_hash_bytes=32 da_wal_content_hash_matches_checkpoint_wal_entry_hash=true checkpoint_binding_fields=height,state_root,wal_entry_hash checkpoint_tuple_order=height,state_root,wal_entry_hash checkpoint_tuple_encoding=sha256(len-prefixed height-le-u64|state_root|wal_entry_hash) checkpoint_commitment_fields=height,state_root,wal_entry_hash checkpoint_commitment_encoding=sha256(len-prefixed height-le-u64|state_root|wal_entry_hash) checkpoint_commitment_binding_kind=tuple-hash checkpoint_commitment={} checkpoint_commitment_kind=canonical-hex-32b checkpoint_commitment_bytes=32 checkpoint_commitment_matches_recomputed=true checkpoint_height=1 checkpoint_height_encoding=le-u64 checkpoint_height_bytes=8 checkpoint_state_root={} checkpoint_state_root_kind=canonical-hex-32b checkpoint_state_root_bytes=32 checkpoint_wal_entry_hash={} checkpoint_wal_entry_hash_kind=canonical-hex-32b checkpoint_wal_entry_hash_bytes=32 checkpoint_height_matches_wal=true checkpoint_state_root_matches_wal=true checkpoint_wal_entry_hash_matches_wal=true checkpoint_wal_binding_kind=content-hash-equality checkpoint_surface_canonical=true wal_content_hash_fields=height,round,proposal_hash,committed,state_root,prev_hash wal_tuple_order=height,round,proposal_hash,committed,state_root,prev_hash wal_tuple_encoding=sha256(len-prefixed height-le-u64|round-le-u64|proposal_hash|committed-u8|state_root|prev_hash?) wal_height=1 wal_height_encoding=le-u64 wal_height_bytes=8 wal_round=0 wal_round_encoding=le-u64 wal_round_kind=bft-round-u64 wal_round_bytes=8 wal_state_root={} wal_state_root_kind=canonical-hex-32b wal_state_root_bytes=32 wal_content_hash={} wal_content_hash_kind=canonical-hex-32b wal_content_hash_bytes=32 wal_content_hash_matches_recomputed=true wal_content_hash_matches_checkpoint=true wal_content_hash_matches_checkpoint_wal_entry_hash=true wal_committed=true wal_committed_encoding=u8 wal_committed_kind=commit-flag-u8 wal_committed_bytes=1 wal_height_boundary_kind=genesis wal_prev_hash=none wal_prev_hash_present=false wal_prev_hash_kind=genesis wal_prev_hash_matches_height_boundary=true wal_prev_hash_bytes=0 wal_prev_hash_surface_policy=canonical-hex-32b-or-none wal_prev_hash_surface_canonical=true wal_linkage_kind=prev-hash-chain wal_proposal_hash=proposal-genesis wal_proposal_hash_present=true wal_proposal_hash_kind=opaque-ascii wal_proposal_hash_bytes=16 wal_proposal_hash_surface_policy=ascii-trimmed-no-ws-control-max128 wal_proposal_hash_surface_canonical=true",
                checkpoint.state_root_hex,
                checkpoint.commitment_hex(),
                wal.content_hash_hex(),
                checkpoint.commitment_hex(),
