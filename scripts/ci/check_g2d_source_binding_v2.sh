...
base=d72848ef5f5f7567eafba97a67921a81b6c8a252
...
assert m['base_pr']==33
assert m['base_commit']=='d72848ef5f5f7567eafba97a67921a81b6c8a252'
assert m['base_tree']=='fd069546f33335109587d4b06d153674fb2e7faf'
...
assert m['a12_publication_head']=='d72848ef5f5f7567eafba97a67921a81b6c8a252'
...
print('G2D source binding v2: synchronized tested A12 wire candidate and false authority guards')
PY
git diff --check
