...
base=5068df3aa46b4585204396b41eedaa8fe2f4a7d9
...
assert m['base_pr']==36
assert m['base_commit']=='5068df3aa46b4585204396b41eedaa8fe2f4a7d9'
assert m['base_tree']=='cf42c401891b985031023aea97f77a6bd0ce4afd'
...
assert a15['base_commit']=='96d4733a941fe2fe5104d378177c8d05475a7af1'
...
print('G2F source binding v2: exact rustfmt-closed A15 lineage, rebound view vector and false authority guards')
PY
git diff --check
