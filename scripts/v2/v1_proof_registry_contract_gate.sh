...
cargo test -p trnm-pouw registry_with_builtin_verifiers_surfaces_envelope_validation_failures
cargo test -p trnm-pouw registry_ignores_empty_verifier_key_after_normalization
...
cargo test -p trnm-pouw registry_is_registered_kind_accepts_horizontal_bar_delimited_aliases
cargo test -p trnm-pouw registry_is_registered_kind_accepts_unicode_minus_delimited_aliases
cargo test -p trnm-pouw registry_is_registered_kind_accepts_zero_width_separated_aliases
cargo test -p trnm-pouw registry_is_registered_kind_accepts_mongolian_vowel_separator_aliases
cargo test -p trnm-pouw registry_is_registered_kind_accepts_soft_hyphen_delimited_aliases
...
cargo test -p trnm-pouw registry_is_registered_kind_accepts_multiline_whitespace_aliases
